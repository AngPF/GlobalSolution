...
import '../Style/GraficosMedicoes.css'
...
const GraficoMedicoes = ({ medicoes }) => {
    ...
    useEffect(() => {
        const limiteMinimo = localStorage.getItem('minGlicemia'); 
        const limiteMaximo = localStorage.getItem('maxGlicemia'); 
    ...
    return (
        <div className='Grafico'>
            ...
            <p className='TextVerde'>Porcentagem de medições dentro do alvo: {porcentagemDentro.toFixed(2)}%</p>
            <p className='TextVermelho'>Porcentagem de medições fora do alvo: {porcentagemFora.toFixed(2)}%</p>
        </div>
    );
};
